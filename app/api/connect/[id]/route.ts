...
export async function GET(
  ...
  // Handle mailto: URLs gracefully to avoid browser HTTP 307 redirect block
...
<html>
  ...
  <body>
    ...
    <p>Opening email client... <a href="${targetUrl}">Click here if it doesn't open automatically</a>.</p>
  </body>
</html>`,
      {
